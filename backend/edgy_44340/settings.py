"""
Django settings for edgy_44340 project.
...
WSGI_APPLICATION = 'edgy_44340.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "edgy_44340 API",
    "DESCRIPTION": "API documentation for edgy_44340 App",
    "VERSION": "v1",
}
